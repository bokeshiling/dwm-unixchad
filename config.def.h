...
static const Key keys[] = {
	...
	/* physical media keys */
	{ 0,                            XF86XK_AudioRaiseVolume, spawn, SHCMD("${HOME}/.local/bin/audio sink --plus") },
	{ 0,                            XF86XK_AudioLowerVolume, spawn, SHCMD("${HOME}/.local/bin/audio sink --minus") },
	{ 0,                            XF86XK_AudioMute, spawn, SHCMD("${HOME}/.local/bin/audio sink --mute") },
	{ 0,                            XF86XK_AudioMicMute, spawn, SHCMD("${HOME}/.local/bin/audio source --mute") },
